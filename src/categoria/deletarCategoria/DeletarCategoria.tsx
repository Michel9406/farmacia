...
function DeletarCategoria() {
    const [categorias, setCategoria] = useState<Categorias>({} as Categorias)
    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                <header className='py-2 px-6 bg-indigo-600 text-white font-bold text-2xl'>{categorias.nome}</header>
